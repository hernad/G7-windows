...
Name: "{userprograms}\Docker\GreenBox SSHD setup"; WorkingDir: "{app}"; Filename: "{pf}\Git\bin\bash.exe"; Parameters: "--login -i ""{app}\sshd_service.sh"""; IconFilename: "{app}/docker-quickstart-terminal.ico"; Components: "Git"
